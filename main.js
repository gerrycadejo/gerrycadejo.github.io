...
function distanceLeft(origin1, destinationA) {
   ...
   function(response, status) {
     ...
     document.getElementById('congratulations').innerHTML = "<h5>🍻 Walking mode on!</h5>";
     }
     ...
     var tenText = 15;
     var tooFar = 110000;
     if (distance.value >= tooFar) {
       document.getElementById('distancelimit').style.display= "block";
       document.getElementById('distancelimit').style.zIndex = "40";
...
function alertaGPS() {
  ...
  alerta.innerHTML = "Please enable your phone's GPS 😁<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>"
  var currentDiv = document.getElementById("landingback");
  document.body.insertBefore(alerta, currentDiv);
}
